...
func (_CrossDomainMessenger *CrossDomainMessengerCaller) ReceiveNonce(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CrossDomainMessenger.contract.Call(opts, &out, "receiveNonce")
...
//
// Solidity: function receiveNonce() view returns(uint256)
func (_CrossDomainMessenger *CrossDomainMessengerSession) ReceiveNonce() (*big.Int, error) {
	return _CrossDomainMessenger.Contract.ReceiveNonce(&_CrossDomainMessenger.CallOpts)
}

// ReceiveNonce is a free data retrieval call binding the contract method 0xf9a94d7f.
//
// Solidity: function receiveNonce() view returns(uint256)
func (_CrossDomainMessenger *CrossDomainMessengerCallerSession) ReceiveNonce() (*big.Int, error) {
	return _CrossDomainMessenger.Contract.ReceiveNonce(&_CrossDomainMessenger.CallOpts)
}
